...
import { NavbarLogged, deleteAccount, signout, getUser, TrelloSignin, GithubSignin,
  RedditSignin, YoutubeSignin, OutlookSignin, OneDriveSignin } from "..";
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            <Row>
              ...
              <Col md={1}>
                <Button className="principal__btn__color" onClick={ () => { navigate("/outlook") }}><FontAwesomeIcon icon={faLink} style={{color: 'white'}}/></Button>
              </Col>
            </Row>
            </div>
            <div className="row__services">
